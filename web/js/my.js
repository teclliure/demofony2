...
angular.module('proposalShowApp', [
        'proposalShowApp.services',
        'ngCookies',
        'ngResource',
        'ngSanitize',
        'ngRoute',
...
angular.module('proposalShowApp').controller('MainCtrl', ['CFG', 'uiGmapGoogleMapApi', '$scope', '$timeout', '$routeParams', '$log', 'Restangular', '$q', 'Security', '$http', function(CFG, uiGmapGoogleMapApi, $scope, $timeout, $routeParams, $log, Restangular, $q, Security, $http) {
