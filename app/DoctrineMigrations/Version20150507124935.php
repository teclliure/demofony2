 ...
 */
class Version20150507124935 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE demofony2_document ADD institutional_document_proposal_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE demofony2_document DROP institutional_document_proposal_id');
    }
}
