 ...
 */
class Version20150507115533 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE demofony2_document ADD institutional_answer_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE demofony2_document DROP institutional_answer_id');
    }
}
