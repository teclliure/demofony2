...
class CitizenForumControllerVotesTest extends AbstractDemofony2ControllerTest
{
...
//
        ...
        $url = $this->getDeleteVoteUrl(2, 10);
        ...
        //test edit
        $url = $this->getPutVoteUrl(2, 10, $voteId);
    ...
    public function getDemofony2Url($ppId = self::CITIZENFORUM_ID, $answerId = self::ANSWER_ID)
    {
        return self::API_VERSION.'/citizenforums/'.$ppId.'/answers/'.$answerId.'/vote';
    }
    ...
    {
        return self::API_VERSION.'/citizenforums/'.$ppId;
    }
